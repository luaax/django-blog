...
from blog.views import(
    index, ola, post_show, PostDetailView, get_all_posts, get_post, PostCreateView, create_post, PostListView,
      SobreTemplateView, 
      PostUpdateView,
      PostDeleteView,
)
...
PostListView, SobreTemplateView, PostUpdateView, PostDeleteView,
post_send, )
